...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	private static final String[] PUBLICMATCHERS_GET = {
			"/produtos/**",
			"/categorias/**",
			"/estados/**"
	};
	
	private static final String[] PUBLICMATCHERS_POST = {
			"/clientes",
			"/auth/forgot/**"
	};
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests()
			.antMatchers(HttpMethod.POST, PUBLICMATCHERS_POST).permitAll()
			.antMatchers(HttpMethod.GET, PUBLICMATCHERS_GET).permitAll()
